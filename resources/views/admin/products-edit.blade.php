                        ...
                        <table class="table table-striped">
                            <form method="POST" action="{{ url('admin/products-update') }}"
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="file" name="proimage" id="proimage" class="form-control"><br>
                                    <img src="{{ asset('pro_img/' . $pro->proimage) }}" alt="Product Image"
                                ...
                                <div class="md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="proprice" name="proprice" class="form-control"
                                            min="0" step="0.01" value="{{ $pro->proprice }}">
                                        <div class="invalid-feedback">
                                ...
                                <div class="md-3">
                                    ...
                                    <input name="discount" id="discount" rows="5" class="form-control"
                                        value="{{ $pro->discount }}"></input>
                                    <div class="invalid-feedback">
                                ...
                                <div class="md-3">
                                    ...
                                    <input name="quantity" id="quantity" rows="5" class="form-control"
                                        value="{{ $pro->proquantity }}">
                                    <div class="invalid-feedback">
