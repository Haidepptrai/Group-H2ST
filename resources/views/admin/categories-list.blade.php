                        ...
                        <tbody>
                            @foreach ($cate as $c)
                                <tr>
                                    ...
                                    <td>{{ $c->status }}</td>
                                    <td>
                                        <a href="{{ url('admin/categories-edit/'.$c->catid) }}"><i class="bi bi-pencil-square"></i></a>   |   <a href="{{ url('admin/categories-delete/'.$c->catid) }}"><i class="bi bi-trash text-danger"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
