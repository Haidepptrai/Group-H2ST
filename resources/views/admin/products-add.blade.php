                            ...
                            <form method="POST" action="{{ url('admin/products-save') }}"
                                ...
                                <div class="md-3">
                                    ...
                                    <input type="text" id="proname" name="proname" class="form-control"
                                        placeholder="Enter name products" required>
                                ...
                                <div class="md-3">
                                    ...
                                    <input type="file" id="proimage" name="proimage" class="form-control" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="md-3">
                                    ...
                                    <input name="discount" id="discount" rows="5" class="form-control" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="bestseller" id="bestseller" class="form-control" required>
