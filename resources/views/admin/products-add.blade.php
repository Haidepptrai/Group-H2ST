                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        <form method="POST" action="{{ url('admin/products-save') }}">
                                            ...
                                            <div class="md-3">
                                                <label for="prodescription" class="form-label">Product descriptions:</label>
                                                <textarea name="prodescription" id="prodescription" rows="5"
                                            ...
                                            <div class="md-3">
                                                ...
                                                <textarea name="prodetails" id="prodetails" rows="5"
                                                    class="form-control" required></textarea>
                                                <div class="invalid-feedback">
