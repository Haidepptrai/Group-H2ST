      ...
      <div class="d-flex align-items-start page-container">
         <div class="nav nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <div class="direction">
               ...
               <button class="nav-link" id="v-pills-changePass-tab" data-bs-toggle="pill" data-bs-target="#v-pills-changePass"
                  type="button" role="tab" aria-controls="v-pills-changePass" aria-selected="false">Change Password</button>
               ...
               <div class="modal fade" id="LogOutAlertModal" tabindex="-1" aria-labelledby="LogOutAlert" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                     <div class="modal-content">
                        ...
                        <div class="modal-footer">
                           ...
                           <button type="button" class="btn"><a class="text-danger" href="{{ route('customerLogout') }}">Logout</a></button>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="personal-setting">
                  ...
                  <form action="{{ route('updateUserProfile', ['id' => session()->get('id') ?? Auth::id()]) }}"
                     ...
                     <div class="container">
                        <div class="row row-cols-2">
                           <div class="col">
                              <label for="userPassDelete" class="text-primary">Enter your password</label>
                              <input type="password" name="userPassDelete" id="userPassDelete"
                                 placeholder="Enter your password" class="form-control">
                           </div>
                           <div class="col">
                              <label for="newPass" class="text-info">Enter your new password</label>
                              <input type="password" id="newPass" placeholder="Enter your password" class="form-control">
                              <label for="newPassConfirm" class="text-info">Confirm your new password</label>
                              <input type="password" id="newPassConfirm" placeholder="Enter your password" class="form-control">
                           </div>
                        </div>
                        <button type="submit" class="btn btn-primary float-end my-5"
                           id="saveChangesBtn">Save
               ...
               <div class="input-password">
                  ...
                  <form action="{{ route('deleteAccount', ['id' => session()->get('id') ?? Auth::id()]) }}"
                     ...
                     <div class="col">
                        ...
                        <input type="password" id="userPassConfirm" placeholder="Enter your password" class="form-control">
                     </div>
