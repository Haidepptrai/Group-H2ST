...
<body>
    <div class="page-container">
        ...
        <main>
                            ...
                            <div class="product-card-item">
                                ...
                                <div class="product-image">
                                    <img src="{{ asset('pro_img/' . $product->proimage) }}"
                                        alt="{{ $product->proname }}" loading="lazy">
                                </div>
                                <div class="product-info">
                                    <a href="{{ url('customer/detail-products/' . $product->proid) }}"
                                        class="product-name" draggable="false">{{ $product->proname }}</a>
            ...
            <div class="banner">
                <img src="../customer/home-page/./banner/banner01.jpg" class="banner-wide-01" loading="lazy">
            ...
            <div class="banner">
                <img src="../customer/home-page/./banner/banner02.jpg" class="banner-wide-02" loading="lazy">
            </div>
                    ...
                    @if ($displayProduct)
                        <div class="product-list">
                            <div class="product-title">
                                ...
                                <a href="{{ url('customer/detail-products/' . $fp->proid) }}" class="addition-link" draggable="false">View more<box-icon
                                        name='chevron-right' color="#373737"></box-icon></a>
                            </div>
                            <div class="product-image">
                                <img src="{{ asset('pro_img/' . $fp->proimage) }}" alt=""
                                    class="product-list-image" loading="lazy">
                            </div>
                        </div>
                    @endif
                @endforeach
            ...
            <div class="order-now">
                ...
                <a href="{{ route('cart') }}" class="addition-link" draggable="false">View more<box-icon
                        name='chevron-right' color="#373737"></box-icon></a>
            </div>
            <div class="services">
